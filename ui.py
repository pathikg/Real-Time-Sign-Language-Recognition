...
button1 = tkinter.Button(window, text="Start", font=(
    "Arial Bold", 12), height=2, width=15)
button1.place(x=625, y=200)

button2 = tkinter.Button(window, text="About", font=(
    "Arial Bold", 12), height=2, width=15)
button2.place(x=625, y=300)

button3 = tkinter.Button(window, text="Contact Us", font=(
    "Arial Bold", 12), height=2, width=15)
button3.place(x=625, y=400)

button4 = tkinter.Button(window, text="Exit", font=(
