...
class Example(Frame):
    def __init__(self, master, *pargs):
        ...
        self.image = Image.open(
            r"E:\Pathik\KJ\sem4\MiniProject\ASL recognition\Canny Edge\images\bg_img.jpeg")
...
load = Image.open(
    r"E: \Pathik\KJ\sem4\MiniProject\ASL recognition\Canny Edge\images\shinyblack2.jpg")
render = ImageTk.PhotoImage(load)
...
load = Image.open(
    r"E:\Pathik\KJ\sem4\MiniProject\ASL recognition\Canny Edge\images\shinyblack1.jpg")
render = ImageTk.PhotoImage(load)
